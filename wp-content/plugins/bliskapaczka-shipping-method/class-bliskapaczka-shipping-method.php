	...
	function show_table( $method ) {
		if ( 'bliskapaczka-courier' === $method->id ) {
			...
			foreach ( $price_list as $item ) {
				...
				echo '<div class="bliskapaczka_courier_item_logo"><img src="https://bliskapaczka.pl/static/images/' . esc_html( $operator_name ) . '.png" alt="' . esc_html( $operator_name ) . '" style="max-width: 100%; height: inherit;"></div>';
